...
// ─────────────────────────────────────────────────────────────────────────────
// Onboarding legal documents — PROVISIONAL placeholders presented + signed in the
// new-association wizard. Replace with lawyer-vetted finals when ready and keep in
// sync with artifacts/stride-app/lib/legal-texts.ts and
// scripts/src/legal/onboarding-legal-content.ts. ASCII quotes only.
// ─────────────────────────────────────────────────────────────────────────────
...
8. CONTACT
Questions about this policy: ${LEGAL_EMAIL}
...
export const LEGAL_DOCS: Record<string, LegalDocMeta> = {
  ...
  "terms-conditions": {
    ...
    subtitle: "Stride Platform - Service Agreement (DRAFT)",
    version: "1.0-draft",
    text: ONB_TERMS_CONDITIONS,
  },
  "media-release": {
    id: "media-release",
    title: "Media Release",
    subtitle: "Stride Platform - Media Responsibility Policy (DRAFT)",
    version: "1.0-draft",
    text: ONB_MEDIA_RELEASE,
  },
  "reimbursement": {
    id: "reimbursement",
    title: "Reimbursement Policy",
    subtitle: "Stride Platform - Refunds & Payments (DRAFT)",
    version: "1.0-draft",
    text: ONB_REIMBURSEMENT,
  },
  "privacy-policy": {
    id: "privacy-policy",
    title: "Privacy Policy",
    subtitle: "Stride Platform - Data Responsibility (DRAFT)",
    version: "1.0-draft",
    text: ONB_PRIVACY_POLICY,
  },
};

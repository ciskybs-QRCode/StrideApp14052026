...
export type SecurityEventType =
  ...
  | "SOCIAL_ARRIVAL_WARNING" // DEPENDANT_MISSING suppressed by social buffer — warning only
  | "EMERGENCY_PUSH"         // Critical alert push dispatched (MEDICAL/FIRE/POLICE/DEPENDANT_MISSING)

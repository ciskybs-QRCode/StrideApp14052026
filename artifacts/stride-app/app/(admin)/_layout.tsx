...
export default function AdminTabLayout() {
  ...
  return (
    ...
    >
      ...
      <Tabs.Screen name="disciplines"    options={{ title: "Disciplines",   tabBarIcon: ({ color, size }) => <Ionicons name="musical-notes"      size={size} color={color} /> }} />
      <Tabs.Screen name="lessons"        options={{ title: "Lessons",       tabBarIcon: ({ color, size }) => <Ionicons name="school-outline"     size={size} color={color} /> }} />

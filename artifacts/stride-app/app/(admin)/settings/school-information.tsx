...
const COUNTRY_TAX: Record<string, TaxConfig> = {
  ...
  IT: { label: "P.IVA / C.F.",       placeholder: "IT 12345678901",             hint: "Italian VAT / Tax Code" },
  ...
  DE: { label: "Steuernummer",        placeholder: "12/345/67890",               hint: "German Tax Authority Number" },
  FR: { label: "SIRET / N° TVA",     placeholder: "12345678901234",             hint: "French SIRET or VAT Number" },
  ES: { label: "NIF / CIF",          placeholder: "A12345678",                  hint: "Spanish Tax ID Number" },
  NZ: { label: "NZBN / IRD",         placeholder: "9429000000000",              hint: "New Zealand Business Number" },
  CH: { label: "UID / MWST",         placeholder: "CHE-123.456.789",            hint: "Swiss Company Identification Number" },
  AT: { label: "UID / Steuernummer", placeholder: "ATU12345678",                hint: "Austrian VAT Number" },
  BE: { label: "BTW / N° TVA",       placeholder: "BE 1234.567.890",            hint: "Belgian VAT Number" },
  NL: { label: "KvK / BTW",          placeholder: "NL123456789B01",             hint: "Dutch VAT Number" },
  PT: { label: "NIF / NIPC",         placeholder: "PT123456789",                hint: "Portuguese Tax ID Number" },
  PL: { label: "NIP / REGON",        placeholder: "1234567890",                 hint: "Polish Tax ID Number" },
  SE: { label: "Org. Nr / VAT",      placeholder: "556000-0000",                hint: "Swedish Organisation Number" },
  NO: { label: "Org. Nr / MVA",      placeholder: "123 456 789 MVA",            hint: "Norwegian Organisation Number" },
  DK: { label: "CVR-nr.",            placeholder: "12345678",                   hint: "Danish Business Register Number" },
  FI: { label: "Y-tunnus",           placeholder: "1234567-8",                  hint: "Finnish Business ID" },
  JP: { label: "法人番号",              placeholder: "1234567890123",              hint: "Hōjin Bangō (Corporate Number)" },
  KR: { label: "사업자등록번호",           placeholder: "123-45-67890",               hint: "Korean Business Registration Number" },
  ...
  BR: { label: "CNPJ / CPF",         placeholder: "12.345.678/0001-90",         hint: "Brazilian National Registry Number" },
  MX: { label: "RFC",                placeholder: "XAXX010101000",              hint: "Mexican Federal Tax Registry" },
  ...
  return (
    <View style={[styles.container, { backgroundColor: colors.background }]}>
      ...
      >
        ...
        <View style={[styles.card, { backgroundColor: colors.card, borderLeftWidth: 3, borderLeftColor: colors.primary }]}>
        ...
        <View style={[styles.sectionHeaderRow, { marginTop: 8 }]}>
          <View style={styles.sectionLabelRow}>
            <View style={[styles.sectionAccentDot, { backgroundColor: colors.secondary }]} />
            ...
            <View style={[styles.toggleRow, { marginTop: 16 }]}>
              <View style={{ flex: 1 }}>
                <View style={{ flexDirection: "row", alignItems: "center", gap: 6 }}>
                  <Ionicons name="star-outline" size={16} color={colors.secondary === colors.secondary ? colors.secondary : colors.primary} />

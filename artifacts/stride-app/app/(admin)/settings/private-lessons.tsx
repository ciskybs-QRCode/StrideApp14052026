      ...
      >
        ...
        <View style={[styles.card, { backgroundColor: colors.card, borderColor: colors.border }]}>
          {[
            ...
            { icon: "cash-outline", color: colors.secondary, title: "Operator payroll auto-credited", desc: "The operator's payout is automatically added to their pending payroll for the current period — no manual entry needed." },
            { icon: "checkmark-circle-outline", color: colors.primary, title: "Operator confirms the slot", desc: "The operator sees the booking in their Invoicing screen and confirms (or requests to reschedule)." },

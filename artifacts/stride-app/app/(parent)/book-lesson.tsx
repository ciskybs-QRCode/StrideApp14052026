          ...
          <>
            {operators.length === 0 ? (
              ...
              operators.map(op => (
                ...
                >
                  <View style={[styles.avatarCircle, { backgroundColor: `${colors.secondary}80` }]}>
          ...
          <>
            {disciplinesForOp.length === 0 ? (
              ...
              disciplinesForOp.map(d => (
                ...
                >
                  <View style={[styles.disciplineCircle, { backgroundColor: `${colors.secondary}60` }]}>
            ...
            {slotsForTime.length === 0 ? (
              ...
              slotsForTime.map(s => {
                ...
                return (
                  ...
                  >
                    <View style={[styles.timeBadge, { backgroundColor: `${colors.secondary}60` }]}>

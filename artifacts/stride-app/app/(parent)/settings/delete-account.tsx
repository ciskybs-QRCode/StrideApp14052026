...
export default function ParentDeleteAccountPage() {
  ...
  return (
    <View style={[styles.container, { backgroundColor: colors.background }]}>
      <ScreenHeader
        ...
        subtitle="Permanently remove your member account"
        onBack={() => router.push("/(parent)/documents" as never)}
      />
      <View style={[styles.inner, { paddingTop: 16, paddingBottom: insets.bottom + 40 }]}>
        ...
        <View style={[styles.warningBox, { backgroundColor: "#FEF2F2" }]}>
          ...
          <View style={{ flex: 1 }}>
            ...
            <Text style={styles.warningDesc}>
              Your member account and login credentials will be permanently deleted. This cannot be undone.
            </Text>
          </View>
        </View>

        {[
          { icon: "person-outline" as const,           text: "Your login and member profile will be removed" },
          { icon: "people-outline" as const,            text: "Dependent profiles belong to the association and will NOT be deleted" },
          { icon: "card-outline" as const,              text: "Cancel any active subscriptions before deleting your account" },
          { icon: "document-text-outline" as const,     text: "Signed documents and enrolment history remain with the association" },
        ].map(item => (
        ...
        <View style={styles.btnRow}>
          <Pressable
            ...
            onPress={() => router.navigate("/(parent)/documents" as never)}
          >

...
export default function DocSignScreen() {
  ...
  const docContent = doc
    ? (DOC_BODY[doc.type] ?? `${doc.title}\n\nPlease read this document carefully before signing. This is a legally binding agreement between you and the Association.`)
    : "";
  ...
  return (
    <View style={[s.container, { backgroundColor: colors.background }]}>
      <ScreenHeader title={doc.title} subtitle="Mandatory Signature" light onBack={() => router.navigate("/(parent)/documents" as never)}
        right={

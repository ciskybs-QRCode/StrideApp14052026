  ...
  return (
    <View style={[styles.container, { backgroundColor: colors.background }]}>
      ...
      >
        ...
        {/* ── Switch Role — immediately below profile ── */}
        <RoleSwitcherRow />

        {/* ── Account hub ── */}
        <Pressable
          style={({ pressed }) => [styles.featureCard, { backgroundColor: colors.card, opacity: pressed ? 0.88 : 1, marginTop: 16 }]}
          onPress={() => { Haptics.impactAsync(Haptics.ImpactFeedbackStyle.Light); router.push("/(operator)/account" as never); }}
        >
        ...
        <Pressable
          ...
          onPress={() => { Haptics.impactAsync(Haptics.ImpactFeedbackStyle.Light); router.push("/(operator)/workspace" as never); }}
        >

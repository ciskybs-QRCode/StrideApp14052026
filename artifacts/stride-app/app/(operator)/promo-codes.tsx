      ...
      >
        {promos.length === 0 ? (
          <View style={styles.emptyState}>
            <View style={[styles.emptyIcon, { backgroundColor: `colors.primary15` }]}>
            ...
            <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={{ paddingBottom: 20 }}>
              ...
              {filteredMembers.slice(0, 6).map(s => (
                <Pressable
                  ...
                  style={[
                    styles.memberRow,
                    { backgroundColor: selectedMemberId === s.id ? `colors.primary18` : colors.muted, borderColor: selectedMemberId === s.id ? colors.primary : colors.border },
                  ]}
                  onPress={() => {
              ...
              {selectedMember && memberCourses.length > 0 && (
                <>
                  ...
                  {!scopeAll && memberCourses.map(course => (
                    <Pressable
                      key={course}
                      style={[styles.courseRow, { backgroundColor: selectedCourses.includes(course) ? `colors.primary18` : colors.muted, borderColor: selectedCourses.includes(course) ? colors.primary : colors.border }]}

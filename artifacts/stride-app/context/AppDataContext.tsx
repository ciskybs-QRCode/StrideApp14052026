...
const FALLBACK_LEGAL_DOCS: LegalAdminDoc[] = [
  ...
  },
  {
    ...
    has_options: true,
    option_labels: { a: "Full consent — photos & videos for all purposes", b: "Internal use only — internal newsletters and records", c: "No consent — do not photograph or film my child" },
    description: "Consent for photography and video recording of your child.",
    content: `MEDIA RELEASE CONSENT\n\nThis consent form relates to the photography and video recording of members enrolled with this association.\n\nDuring sessions, performances, showcases, and other events, we may capture photographs and video footage. This media may be used for promotional, educational, and documentary purposes.\n\nYou are required to select one of the following consent options:\n\nOPTION A — Full Consent\nYou consent to photographs and videos of your child being used for all association purposes, including but not limited to: the association website, social media channels, printed promotional materials, and internal records.\n\nOPTION B — Internal Use Only\nYou consent to photographs and videos being used exclusively for internal purposes such as internal newsletters, private member communications, and internal training documentation. Media will not be published publicly.\n\nOPTION C — No Consent\nYou do not consent to your child being photographed or filmed. The association will make reasonable efforts to ensure your child is excluded from all media capture. Please note this may affect participation in certain group activities.\n\nThis consent applies for the duration of your child's enrolment and may be updated in writing at any time by contacting the association administrator.`,
  },
];

...
> = {
  ...
  grace_allowed: {
    ...
    labelColor: "#FCD34D",
    title: "Entry Granted — Payment Reminder",
    body: "Welcome! Please note your membership payment is overdue. This is a courtesy entry. Please arrange payment before your next session.",
    badge: "COURTESY ENTRY",
    badgeBg: "#D97706",
  },
  overdue_denied: {
    bg: "#450A0A",

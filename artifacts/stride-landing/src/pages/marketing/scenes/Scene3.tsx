      ...
      <div className="z-10 w-[40%] relative h-[80vh] flex items-center justify-center">
        ...
        >
          ...
          <div className="h-[15%] bg-[#1E3A8A] p-6 text-white flex flex-col justify-end">
            ...
            <div className="text-[1.8vw] font-bold">Emma Collins</div>
          </div>
          ...
          <div className="p-6 bg-gray-50 h-full">
            ...
            >
              <div className="text-[1.4vw] font-bold text-gray-800">Junior Gymnastics</div>
            ...
            >
              ...
              <div className="text-[1.6vw] font-bold">End of Season Showcase</div>

...
export default function Brochure() {
  ...
  const PLANS = [
    {
      name: "Core",
      price: getPrice("core", curr.code),
      features: ["Up to 100 members", "QR Attendance", "Smart Pick-Up", "Online Payments", "SOS Emergency"],
      highlight: false,
    },
    {
      name: "Plus",
      price: getPrice("plus", curr.code),
      features: ["Up to 300 members", "Everything in Core", "AI Roster Optimizer", "Marketplace", "Multi-association"],
      highlight: true,
    },
    {
      name: "Premium",
      price: getPrice("premium", curr.code),
      features: ["Unlimited members", "Everything in Plus", "White-label branding", "Dedicated support", "Custom integrations"],
      highlight: false,
    },
  ];

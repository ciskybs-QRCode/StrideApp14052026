      ...
      <div className="max-w-6xl mx-auto px-5 py-14">
        ...
        <div className="mb-10">
          ...
          <p className="text-slate-500 text-sm">
            Last updated: <strong>1 June 2026</strong> &nbsp;&middot;&nbsp; GDPR Compliant
          </p>
          <p className="text-slate-600 text-sm leading-relaxed mt-4 max-w-2xl">
            This Privacy Policy describes how Stride Platform collects, uses, and protects your personal data. We are committed to full transparency and your right to control your information.
          </p>
        </div>
        ...
        <div className="flex flex-wrap gap-3 mb-8">
          {[
            { label: "GDPR Compliant",     icon: <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z" /></svg> },
            { label: "AES-256 Encrypted",  icon: <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5"><rect x="3" y="11" width="18" height="11" rx="2" /><path d="M7 11V7a5 5 0 0110 0v4" /></svg> },
            { label: "No Data Selling",    icon: <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5"><circle cx="12" cy="12" r="10" /><line x1="4.93" y1="4.93" x2="19.07" y2="19.07" /></svg> },
            { label: "Children's Data Protected", icon: <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z" /><polyline points="9 12 11 14 15 10" /></svg> },
          ].map(({ label, icon }) => (
